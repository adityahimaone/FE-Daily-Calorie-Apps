...
export default function Home() {
  ...
  return (
    <GuestLayout loc="home" container={false}>
      {/* Hero */}
      <section className="container mx-auto px-10 flex flex-col-reverse lg:flex-row max-h-fit py-10 lg:py-28 items-center ">
        ...
        <div className="flex-1 flex flex-col w-full justify-center relative">
          ...
          <div className="absolute right-0 lg:-right-0 top-6 lg:top-28 flex flex-col py-5 px-7 rounded-2xl shadow-xl bg-white/80 backdrop-blur-xl hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
          ...
          <div class="hidden md:flex justify-end space-x-1 font-bold">
            ...
            <span>EDAMAMA API</span>
          </div>
        </div>
      </section>
      <section className="flex flex-col lg:flex-row items-center justify-around bg-white py-10">
        <div>
        ...
        <div className=" max-w-md space-y-5">
          ...
          <p className="text-gray-600">
            ...
            the food database that is already available
          </p>
        </div>
      </section>
      <section className="container mx-auto px-10 flex justify-center items-center flex-col py-10 space-y-4">
        <div className="text-center">
          <h1 className="text-2xl font-semibold">FAQ</h1>
          <p className="text-gray-600">more information can be read here</p>
        </div>
